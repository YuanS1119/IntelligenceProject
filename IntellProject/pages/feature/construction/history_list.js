...
Page({
    ...
    initPage: function (callback) {
        ...
        util.getHttp('/v1/installManageCommon/findInstallInfoVoPage', {
            pageSize: 10, page: this.data.page, dataStatus: 1
        }, function (res) {
            ...
            if (res.data == null) {
                ...
                let lists = res.data.item.rows;
                for (let key in lists) {
                    lists[key].time = util.formatTime(lists[key].createDate, "Y-m-d H:i:s")
                }
                _this.setData({
    ...
    onReachBottom: function () {
        ...
        let _this = this;
        util.getHttp('/v1/installManageCommon/findInstallInfoVoPage', {
            pageSize: 10, page: 1 + page, dataStatus: 1
        }, function (res) {
